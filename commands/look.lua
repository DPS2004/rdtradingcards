  ...
  if #mt == 1 or mt[1] == "" then
    ...
    elseif medaltexttofn(mt[1]) then
      ...
      elseif (string.lower(mt[1]) == "poster" or string.lower(mt[1]) == "catposter" or string.lower(mt[1]) == "cat poster") and wj.labdiscovered  then 
        local postermessage = {'The **Cat Poster** depicts a cat hanging from a branch. It looks quite pleased to be there.', 'The **Cat Poster** is a poster of a cat dangling from a tree branch. The cat looks like it is almost ready to let go.', 'The **Cat Poster**, despite its name, contains no cats. There never was a cat here.','The **Cat Poster** looks back.','The **Cat Poster** shows a scene of a cat with a top hat doing a funny little dance on top of a branch. It truly is impossible to not be charmed by it.',"The **Cat Poster** is really less of a poster and more of an anatomical image of a cat. It would not look out of place in a vet's office.", 'The **Cat Poster** looks very worn out. You can barely make out the cat and the branch.', 'The **Cat Poster** contains a map of the area with certain spots marked on it. Once could only presume that cats could be found at these locations.','The **Cat Poster** is a sheet of A4 paper that says "cat" on it. The letters are in the most plain and boring font imaginable.', "The `cat` **Poster** is a printout of the wikipedia article on the Unix `cat` command. How Informative!", "The **CATS Poster** is a poster of a very outdated meme. Despite this, it makes you chuckle." }
        local posterimage = {"https://cdn.discordapp.com/attachments/829197797789532181/838790920761638982/poster1.png","https://cdn.discordapp.com/attachments/829197797789532181/838790936162992238/poster2.png","https://cdn.discordapp.com/attachments/829197797789532181/838790956483346462/poster3.png","https://cdn.discordapp.com/attachments/829197797789532181/838791958905618462/poster4.png","https://cdn.discordapp.com/attachments/829197797789532181/838791028785020968/poster5.png","https://cdn.discordapp.com/attachments/829197797789532181/838799811813441607/poster6.png","https://cdn.discordapp.com/attachments/829197797789532181/838791029133017109/poster7.png","https://cdn.discordapp.com/attachments/829197797789532181/838791030954393660/poster8.png","https://cdn.discordapp.com/attachments/829197797789532181/838799792267067462/poster9.png","https://cdn.discordapp.com/attachments/829197797789532181/838864622878588989/poster10.png","https://cdn.discordapp.com/attachments/829197797789532181/838870206687346768/poster11.png"}
