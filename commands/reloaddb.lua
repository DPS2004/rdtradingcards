...
function command.run(message, mt,overwrite)
  ...
  if authcheck then
    ...
    _G['defaultjson'] = {inventory={},storage={},medals={},items={nothing=true},lastpull=-24,lastprayer=-7,lastequip=-24,lastbox=-24,tokens=0,pronouns={their="their",them="them",theirself="theirself",they="they",theirs="theirs"}}
